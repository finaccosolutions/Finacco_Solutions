      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="group h-[420px]">
              <div className="relative h-full">
                ...
                <div className={`relative h-full bg-white rounded-[2rem] shadow-lg p-8 transition-all duration-500 hover:shadow-2xl border border-gray-100 group-hover:border-transparent ${service.hoverBg}`}>
                  ...
                  <div className="relative flex flex-col h-full">
                    ...
                    <h3 className="text-xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r group-hover:bg-gradient-to-r from-gray-800 to-gray-600 group-hover:from-blue-600 group-hover:to-purple-600 transition-colors duration-300">{service.title}</h3>
                    <p className="text-gray-600 group-hover:text-gray-700 transition-colors duration-300 flex-grow">{service.description}</p>
                    {service.link && (
                      <a
                        href={service.link}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center mt-4 py-2 px-4 rounded-lg bg-gradient-to-r from-gray-50 to-gray-100 hover:from-blue-50 hover:to-purple-50 text-gray-700 group-hover:text-blue-600 transition-all duration-300 group-hover:translate-x-2"
                      >
                        Learn More
