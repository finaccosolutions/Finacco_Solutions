            ...
            <div className="relative bg-white rounded-[3rem] shadow-xl p-8 md:p-12 border-8 border-blue-100/50 backdrop-blur-sm">
              ...
              <div className="space-y-6 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
                  <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 transform hover:scale-105 transition-transform duration-300 border border-blue-100/50 shadow-lg hover:shadow-xl">
                  ...
                  <div className="bg-gradient-to-br from-teal-50 to-blue-50 rounded-xl p-6 transform hover:scale-105 transition-transform duration-300 border border-teal-100/50 shadow-lg hover:shadow-xl">
