        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold">Custom Software Solutions</h2>
              <p className="text-gray-600">
                We develop custom software solutions that streamline your business processes and drive efficiency.
                Our team of expert developers creates robust, scalable applications tailored to your needs.
              </p>
              
              <div className="space-y-4">
                <h3 className="text-xl font-semibold">Our Development Services:</h3>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <h3 className="text-2xl font-semibold mb-6">Discuss Your Project</h3>
